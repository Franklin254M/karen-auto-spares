...
function renderNavigation() {
  const links = isAdmin() ? [['overview', '⌂ Overview'], ['sales', '↗ Sales & receipts'], ['inventory', '▦ Inventory'], ['purchasing', '＋ Purchasing'], ['customers', '◎ Customers'], ['reports', '▤ Reports']] : [['sales', '↗ Sales & receipts']];
...
function renderPage(view) {
  const titles = { overview: 'Good morning', sales: 'Sales & receipts', inventory: 'Inventory', purchasing: 'Purchasing', customers: 'Customers & vehicles', reports: 'Reports' };
  $('#page-title').textContent = titles[view];
  $('#page-content').innerHTML = ({ overview: overviewPage, sales: salesPage, inventory: inventoryPage, purchasing: purchasingPage, customers: customersPage, reports: reportsPage }[view])();
